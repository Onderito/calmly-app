  ...
  return (
    <button
      className={clsx(
        ...
        {
          // Primary style
          "bg-[#86C0FA] font-manrope-bold text-[16px] px-0 text-white py-4 hover:bg-[#6bb2f7]  ":
            variant === "primary",
          // Secondary style
          "border font-manrope-bold  border-[#404040] text-[16px] px-2 py-4 text-[#404040] bg-transparent rounded-lg  hover:bg-[#eaf6ff]":
            variant === "secondary",
          // message style blur
