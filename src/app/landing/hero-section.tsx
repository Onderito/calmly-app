...
export default function HeroSection() {
  return (
    <section>
      <h1 className="text-[#404040] font-manrope font-bold text-[38px] text-center leading-tight md:text-[64px] md:leading-18">
        Prenez soin de votre esprit, quelques minutes par jour.
      </h1>
      <p className="text-[16px] text-[#404040] font-manrope text-center mt-6 md:text-[18px]">
      ...
      <div className="flex justify-center items-end mt-10 relative">
        ...
        <div className="z-0 relative">
          ...
          <Image
            className="rounded-3xl shadow-lg ring-4 ring-[#F3F3F3] -rotate-2 w-[150px] md:w-[180px]"
            src="/sad.webp"
            alt="sad"
            width={180}
            height={180}
